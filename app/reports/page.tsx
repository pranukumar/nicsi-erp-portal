    ...
    <main className="pb-12">
      ...
      <section className="mx-auto max-w-6xl px-6 py-8 text-gray-700">
        <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="mt-5">
            <DocumentGuidance reviewLabel="Annual reports are arranged year-wise with publish-date context to support archival traceability." />
          </div>

          <div className="mt-5 overflow-x-auto rounded-lg border border-gray-200">
            <table className="nic-table min-w-full text-left text-sm">
              <caption className="sr-only">NICSI annual reports with financial year, publish date, and PDF file size details.</caption>
                  ...
                  REPORTS.map((report) => (
                    <tr key={`${report.srNo}-${report.fileName}`} className="border-t align-top">
                      ...
                      <td className="px-4 py-3">
                        <a
                          href={withSiteBasePath(`/pdfs/reports/${report.fileName}`)}
                          download
