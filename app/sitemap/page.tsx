...
const links: { label: string; href: string }[] = [
  ...
  { label: "Headquarters Personnel", href: "/headquarters-personnel" },
  { label: "State Personnel", href: "/state-personnel" },
  { label: "Work Allocation", href: "/work-allocation" },
  ...
  { label: "Active Tenders", href: "/active-tenders" },
